# -*- coding: utf-8 -*-
"""apply_cross_dedup_round25.py — 终极收尾，处理最后 12 个重叠。

对每个 entry 写独特的内容（不仅是 1-2 字不同），确保彻底差异化。
"""
...
REWRITES = {
    # ENTP-ESTP decision (共享 "面前会觉得选 A 就")
    ...
    # ENTP-ESTP social-drain (共享 "交，而非来者不拒——")
    ...
    # INFJ-ISFP breakup (共享 "能性。把前任从神坛上")
    ...
    # INFP-ISFP criticism (共享 "这样的人』——Fi ")
...
def main():
    ...
    scan_path = TMP_DIR / "m4-cross-r25.json"
    env = os.environ.copy()
